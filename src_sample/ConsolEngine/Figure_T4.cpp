...
Figure_T4::Figure_T4() : Figure_Parent()
{
	...
	_blocks[3] = new Block(0, 3, '&', my_enums::Down);
	_state = my_enums::Down;
}

Figure_T4::Figure_T4(const Figure_T4 & obj) :Figure_Parent(obj)
{
}

Figure_T4::Figure_T4(Figure_T4 && obj)
{
	this->_x = obj._x;
	this->_y = obj._y;
...
Figure_T4 &Figure_T4::operator=(Figure_T4 && obj)
{
	if (this != &obj)
	{
...
Figure_T4 & Figure_T4::operator=(const Figure_T4 & obj)
{
	if (this != &obj)
	{
		Figure_Parent::operator= (obj);
...
Figure_T4::Figure_T4(int x, int y) : Figure_Parent(x, y)
{
	_size = 4;
	this->_state_block = my_enums::T4;
	_blocks = new Block *[_size];
...
my_enums::Block Figure_T4::Get_state_block()
{
	return _state_block;
}
my_enums::Rotate Figure_T4::Get_state_rotate()
{
	return this->_state_rotate;
}
my_enums::Move Figure_T4::Get_state()
{
	return _state;
}
#pragma endregion
...
void Figure_T4::Set_state(my_enums::Move _state)
{
	this->_state = _state;
}
void Figure_T4::Set_state_block(my_enums::Block _state)
{
	this->_state_block = _state;
}
void Figure_T4::Set_state_rotate(my_enums::Rotate _state)
{
