...
#pragma region system
	Figure_T5(int x, int y);
	Figure_T5();
	Figure_T5(const Figure_T5& obj);// Конструктор копирования------------------
	Figure_T5(Figure_T5 && obj);//кoнструктор переноса-----------------------------------
	Figure_T5  &operator =(Figure_T5  && obj);//Присв с переносом --------------------------
	Figure_T5  &operator =(const Figure_T5  & obj);//Присв с копированием --------------------------
	~Figure_T5();
#pragma endregion
