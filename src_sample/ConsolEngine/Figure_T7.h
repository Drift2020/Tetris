...
#pragma region system
	Figure_T7(int x, int y);
	Figure_T7();
	Figure_T7(const Figure_T7& obj);// Конструктор копирования------------------
	Figure_T7(Figure_T7 && obj);//кoнструктор переноса-----------------------------------
	Figure_T7  &operator =(Figure_T7  && obj);//Присв с переносом --------------------------
	Figure_T7  &operator =(const Figure_T7  & obj);//Присв с копированием --------------------------
	~Figure_T7();
#pragma endregion
