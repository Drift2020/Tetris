...
Figure_T7::Figure_T7(const Figure_T7 & obj) :Figure_Parent(obj)
{
}

Figure_T7::Figure_T7(Figure_T7 && obj)
{
	this->_x = obj._x;
	this->_y = obj._y;
...
Figure_T7 &Figure_T7::operator=(Figure_T7 && obj)
{
	if (this != &obj)
	{
...
Figure_T7 & Figure_T7::operator=(const Figure_T7 & obj)
{
	if (this != &obj)
	{
		Figure_Parent::operator= (obj);
...
Figure_T7::Figure_T7(int x, int y) : Figure_Parent(x, y)
{
	_size = 4;
	this->_state_block = my_enums::T7;
	_blocks = new Block *[_size];
...
my_enums::Block Figure_T7::Get_state_block()
{
	return _state_block;
}
my_enums::Rotate Figure_T7::Get_state_rotate()
{
	return this->_state_rotate;
}
my_enums::Move Figure_T7::Get_state()
{
	return _state;
}
#pragma endregion
...
void Figure_T7::Set_state(my_enums::Move _state)
{
	this->_state = _state;
}
void Figure_T7::Set_state_block(my_enums::Block _state)
{
	this->_state_block = _state;
}
void Figure_T7::Set_state_rotate(my_enums::Rotate _state)
{
