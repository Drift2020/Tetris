...
{
	_size = 4;
	this->_state_block = my_enums::T6;
	_blocks = new Block*[_size];


	_blocks[0] = new  Block(1, 0, '&', my_enums::Down);;

	_blocks[1] = new  Block(2, 0, '&', my_enums::Down);
...
Figure_T6::Figure_T6(const Figure_T6 & obj) :Figure_Parent(obj)
{
}

Figure_T6::Figure_T6(Figure_T6 && obj)
{
	this->_x = obj._x;
	this->_y = obj._y;
...
Figure_T6 &Figure_T6::operator=(Figure_T6 && obj)
{
	if (this != &obj)
	{
...
Figure_T6 & Figure_T6::operator=(const Figure_T6 & obj)
{
	if (this != &obj)
	{
		Figure_Parent::operator= (obj);
...
Figure_T6::Figure_T6(int x, int y) : Figure_Parent(x, y)
{
	_size = 4;
	this->_state_block = my_enums::T6;
	_blocks = new Block *[_size];
...
my_enums::Block Figure_T6::Get_state_block()
{
	return _state_block;
}
my_enums::Rotate Figure_T6::Get_state_rotate()
{
	return this->_state_rotate;
}
my_enums::Move Figure_T6::Get_state()
{
	return _state;
}
#pragma endregion
...
void Figure_T6::Set_state(my_enums::Move _state)
{
	this->_state = _state;
}
void Figure_T6::Set_state_block(my_enums::Block _state)
{
	this->_state_block = _state;
}
void Figure_T6::Set_state_rotate(my_enums::Rotate _state)
{
