...
#pragma region system
	Figure_T3(int x, int y);
	Figure_T3();
	Figure_T3(const Figure_T3& obj);// Конструктор копирования------------------
	Figure_T3(Figure_T3 && obj);//кoнструктор переноса-----------------------------------
	Figure_T3  &operator =(Figure_T3  && obj);//Присв с переносом --------------------------
	Figure_T3  &operator =(const Figure_T3  & obj);//Присв с копированием --------------------------
	~Figure_T3();
#pragma endregion
