...
Figure_T3::Figure_T3(const Figure_T3 & obj) :Figure_Parent(obj)
{
}

Figure_T3::Figure_T3(Figure_T3 && obj)
{
	this->_x = obj._x;
	this->_y = obj._y;
...
Figure_T3 &Figure_T3::operator=(Figure_T3 && obj)
{
	if (this != &obj)
	{
...
Figure_T3 & Figure_T3::operator=(const Figure_T3 & obj)
{
	if (this != &obj)
	{
		Figure_Parent::operator= (obj);
...
my_enums::Block Figure_T3::Get_state_block()
{
	return _state_block;
}
my_enums::Rotate Figure_T3::Get_state_rotate()
{
	return this->_state_rotate;
}
my_enums::Move Figure_T3::Get_state()
{
	return _state;
}
#pragma endregion
...
void Figure_T3::Set_state(my_enums::Move _state)
{
	this->_state = _state;
}
void Figure_T3::Set_state_block(my_enums::Block _state)
{
	this->_state_block = _state;
}
void Figure_T3::Set_state_rotate(my_enums::Rotate _state)
{
