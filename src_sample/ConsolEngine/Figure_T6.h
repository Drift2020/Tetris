...
#pragma region system
	Figure_T6(int x, int y);
	Figure_T6();
	Figure_T6(const Figure_T6& obj);// Конструктор копирования------------------
	Figure_T6(Figure_T6 && obj);//кoнструктор переноса-----------------------------------
	Figure_T6  &operator =(Figure_T6  && obj);//Присв с переносом --------------------------
	Figure_T6  &operator =(const Figure_T6  & obj);//Присв с копированием --------------------------
	~Figure_T6();
#pragma endregion
