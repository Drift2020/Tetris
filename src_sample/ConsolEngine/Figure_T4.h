...
#pragma region system
	Figure_T4(int x, int y);
	Figure_T4();
	Figure_T4(const Figure_T4& obj);// Конструктор копирования------------------
	Figure_T4(Figure_T4 && obj);//кoнструктор переноса-----------------------------------
	Figure_T4  &operator =(Figure_T4  && obj);//Присв с переносом --------------------------
	Figure_T4  &operator =(const Figure_T4  & obj);//Присв с копированием --------------------------
	~Figure_T4();
#pragma endregion
